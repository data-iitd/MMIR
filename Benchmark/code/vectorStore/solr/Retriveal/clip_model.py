...
class CLIPSemanticSearcher:
    def __init__(self, solr_url="http://localhost:8983/solr", core_name="Coco_caption_test",modality="text"):
    ...
    def initialize(self) -> bool:
        try:
            print("Loading OpenAI CLIP model (ViT-L/14@336px)...")
